function ImportPS(ctx)
    ...
    exp = proj.insertExperiment('cell 2', datetime(2012,7,31));
    ...
    exp = proj.insertExperiment('cell 3', datetime(2012,8,1));
    ...
    exp = proj.insertExperiment('cell 4', datetime(2012,8,2));
